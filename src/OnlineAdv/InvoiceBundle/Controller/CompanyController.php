...
use OnlineAdv\InvoiceBundle\Entity\Company;
use OnlineAdv\InvoiceBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('InvoiceBundle:Company')->findAll();
    ...
    {
        $company = new Company();
        $form = $this->createForm('OnlineAdv\InvoiceBundle\Form\CompanyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('OnlineAdv\InvoiceBundle\Form\CompanyType', $company);
